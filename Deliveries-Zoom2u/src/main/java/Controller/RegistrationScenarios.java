...
public class RegistrationScenarios extends LaunchBrowser_inCrossBrowser{
	...
	public void RedirecttoRegisterpage() throws InterruptedException{
		...
		driver.findElement(By.xpath(obj1.SignupTabLocator())).click();
		Thread.sleep(10000);
		String Actualresult=driver.findElement(By.xpath(obj1.SignupbtnLocator())).getText();
		System.out.println(Actualresult);
		Assert.assertEquals(Actualresult, "Sign up");
	...
	public void RegistrationFailedwithoutFields() throws InterruptedException{
		...
		element = Driverwaitclass.Driverwait().until(ExpectedConditions.elementToBeClickable(By.xpath(obj1.SignupTabLocator())));
		driver.findElement(By.xpath(obj1.SignupTabLocator())).click();
		element = Driverwaitclass.Driverwait().until(ExpectedConditions.elementToBeClickable(By.xpath(obj1.SignupbtnLocator())));
		driver.findElement(By.xpath(obj1.SignupbtnLocator())).click();
		element = Driverwaitclass.Driverwait().until(ExpectedConditions.elementToBeClickable(By.xpath(obj1.FirstnamevalidLocator())));
		...
		System.out.println("First name is"+ Firstnamevalidation);
		...
		System.out.println("Last name is"+ Lnamevalidation);
		...
		System.out.println("Phone number is"+ PhoneNovalidation);
		...
		System.out.println("Email is"+ Emailvalidation);
		...
		System.out.println("Pwd validation is"+ Pwdvalidation);
	...
	System.out.println("Confirm Password is"+ ConfirmPwdvalidation);
	...
	System.out.println("Terms is"+ Termsvalidation);
	...
	public void AlreadyRegisteredValidationcheck(String Name, String LName, int PhoneNo, String Email, String Password, String ConfirmPwd) throws InterruptedException{
	    ...
	    Thread.sleep(10000);
	    String RedirecttoLogin=driver.findElement(By.xpath(objlogin.loginbtnlocator())).getText();
	    Assert.assertEquals(RedirecttoLogin, "Log in");
	    driver.navigate().refresh();
	    driver.findElement(By.xpath(obj1.SignupTabLocator())).click();
	    obj3.FieldsRequiredForRegistration(Name, LName, PhoneNo, Email, Password, ConfirmPwd);
	    Thread.sleep(10000);
	...
	public void PwdConfirmPwdMissmatchValid(String Name, String LName, int PhoneNo, String Email, String Password, String ConfirmPwd) throws InterruptedException{
		...
		System.out.println("Pwd/Confirm pwd validation msg is"+ PwdConfirmPwdValidation);
